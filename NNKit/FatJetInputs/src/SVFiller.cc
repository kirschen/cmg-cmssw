...
void SVFiller::readConfig(const edm::ParameterSet& iConfig, edm::ConsumesCollector& cc) {
  vtxToken_ = cc.consumes<reco::VertexCollection>(edm::InputTag("offlineSlimmedPrimaryVertices"));
  svToken_ = cc.consumes<reco::VertexCompositePtrCandidateCollection>(edm::InputTag("slimmedSecondaryVertices"));
}
