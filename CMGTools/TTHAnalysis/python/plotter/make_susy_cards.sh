...
if [[ "$2" == "1l-2015" ]]; then
    ...
    echo "Making individual datacards"
    for ST in ST0 ST1 ST2 ST3 ST4; do for nJ in 45j 68j 6Infj 9Infj 68TTj 9InfTTj; do for nB in 2B 3p; do for HT in HT0 HT1 HTDPhi HTStop HTTop HTLowLepPt HTLowLepPtDPhi HTTTYes HTTTNo; do
